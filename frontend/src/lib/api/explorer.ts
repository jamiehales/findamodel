...
export interface AppConfig {
  ...
  autoSupportSuctionMultiplier: number;
  autoSupportAreaGrowthThreshold: number;
  autoSupportAreaGrowthMultiplier: number;
  autoSupportGravityEnabled: boolean;
  autoSupportDragCoefficientMultiplier: number;
  autoSupportMinFeatureWidthMm: number;
  autoSupportShrinkagePercent: number;
  autoSupportShrinkageEdgeBias: number;
